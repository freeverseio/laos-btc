...
mod tests {
	...
	fn default_index_does_not_index_runes() {
		...
		context.etch(
			Runestone {
				etching: Some(Etching { rune: Some(Rune(RUNE)), ..default() }),
				..default()
			},
			1,
		);
	...
	fn runes_must_be_greater_than_or_equal_to_minimum_for_height() {
		...
		{
			let context = Context::builder().chain(Chain::Regtest).arg("--index-runes").build();
			...
			context.assert_runes(
				[(
					...
					RuneEntry {
						block: id.block,
						etching: txid,
						spaced_rune: SpacedRune { rune: Rune(minimum), spacers: 0 },
						premine: u128::MAX,
						timestamp: id.block,
						..default()
					},
	...
	fn etching_cannot_specify_reserved_rune() {
		{
			...
			context.etch(
				Runestone {
					edicts: vec![Edict { id: RuneId::default(), amount: u128::MAX, output: 0 }],
					etching: Some(Etching { rune: Some(Rune::reserved(0, 0)), ..default() }),
					..default()
				},
				1,
			);
	...
	fn reserved_runes_may_be_etched() {
		...
		let txid0 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![Edict { id: RuneId::default(), amount: u128::MAX, output: 0 }],
					etching: Some(Etching { rune: None, premine: Some(u128::MAX), ..default() }),
					..default()
				}
				.encipher(),
			),
		...
		context.assert_runes(
			[(
				...
				RuneEntry {
					block: id0.block,
					etching: txid0,
					spaced_rune: SpacedRune { rune: Rune::reserved(id0.block, id0.tx), spacers: 0 },
					premine: u128::MAX,
					timestamp: 2,
					..default()
				},
			)],
			[(OutPoint { txid: txid0, vout: 0 }, vec![(id0, u128::MAX)])],
		);
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![Edict { id: RuneId::default(), amount: u128::MAX, output: 0 }],
					etching: Some(Etching { premine: Some(u128::MAX), rune: None, ..default() }),
					..default()
				}
				.encipher(),
			),
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid0, vout: 0 }, vec![(id0, u128::MAX)]),
				(OutPoint { txid: txid1, vout: 0 }, vec![(id1, u128::MAX)]),
			],
		);
	}
	...
	fn allocations_over_max_supply_are_ignored() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: u128::MAX, output: 0 },
					Edict { id: RuneId::default(), amount: u128::MAX, output: 0 },
				],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
	...
	fn allocations_partially_over_max_supply_are_honored() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: u128::MAX / 2, output: 0 },
					Edict { id: RuneId::default(), amount: u128::MAX, output: 0 },
				],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
	...
	fn etching_may_allocate_less_than_max_supply() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: 100, output: 0 }],
				etching: Some(Etching { rune: Some(Rune(RUNE)), premine: Some(100), ..default() }),
				..default()
			},
			1,
		);
	...
	fn etching_may_allocate_to_multiple_outputs() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: 100, output: 0 },
					Edict { id: RuneId::default(), amount: 100, output: 1 },
				],
				etching: Some(Etching { rune: Some(Rune(RUNE)), premine: Some(200), ..default() }),
				..default()
			},
			1,
		);
	...
	fn allocations_to_invalid_outputs_produce_cenotaph() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: 100, output: 0 },
					Edict { id: RuneId::default(), amount: 100, output: 3 },
				],
				etching: Some(Etching { rune: Some(Rune(RUNE)), ..default() }),
				..default()
			},
	...
	fn input_runes_may_be_allocated() {
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid0, vout: 0 }, vec![(id, u128::MAX)])],
		);

		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			inputs: &[(id.block.try_into().unwrap(), 1, 0, Witness::new())],
			op_return: Some(
				Runestone { edicts: vec![Edict { id, amount: u128::MAX, output: 0 }], ..default() }
					.encipher(),
			),
			..default()
		});
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX)])],
		);
	}
	...
	fn input_runes_are_burned_if_an_unrecognized_even_tag_is_encountered() {
		...
		context.core.broadcast_tx(TransactionTemplate {
			inputs: &[(id.block.try_into().unwrap(), 1, 0, Witness::new())],
			op_return: Some(Runestone { pointer: Some(10), ..default() }.encipher()),
			..default()
		});
	...
	fn unallocated_runes_are_assigned_to_default_output() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			inputs: &[(id.block.try_into().unwrap(), 1, 0, Witness::new())],
			outputs: 2,
			op_return: Some(Runestone { pointer: Some(1), ..default() }.encipher()),
			..default()
		});
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid1, vout: 1 }, vec![(id, u128::MAX)])],
		);
	}
	...
	fn unallocated_runes_are_burned_if_default_output_is_op_return() {
		...
		context.core.broadcast_tx(TransactionTemplate {
			inputs: &[(id.block.try_into().unwrap(), 1, 0, Witness::new())],
			outputs: 2,
			op_return: Some(Runestone { pointer: Some(2), ..default() }.encipher()),
			..default()
		});
	...
	fn output_may_hold_multiple_runes() {
			...
			[
				...
				(
					...
					RuneEntry {
						block: id1.block,
						etching: txid1,
						spaced_rune: SpacedRune { rune: Rune(RUNE + 1), spacers: 0 },
						premine: u128::MAX,
						timestamp: id1.block,
						number: 1,
						..default()
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid2, vout: 0 }, vec![(id0, u128::MAX), (id1, u128::MAX)])],
		);
	}
	...
	fn multiple_input_runes_on_the_same_input_may_be_allocated() {
		...
		let txid3 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![
						Edict { id: id0, amount: u128::MAX / 2, output: 1 },
						Edict { id: id1, amount: u128::MAX / 2, output: 1 },
					],
					..default()
				}
				.encipher(),
		...
		context.assert_runes(
			...
			[
				(
					OutPoint { txid: txid3, vout: 0 },
					vec![(id0, u128::MAX / 2 + 1), (id1, u128::MAX / 2 + 1)],
				),
				(
					OutPoint { txid: txid3, vout: 1 },
	...
	fn multiple_input_runes_on_different_inputs_may_be_allocated() {
		...
		let txid2 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![
						Edict { id: id0, amount: u128::MAX, output: 0 },
						Edict { id: id1, amount: u128::MAX, output: 0 },
					],
					..default()
				}
				.encipher(),
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![
						Edict { id: RuneId::default(), amount: 100, output: 0 },
						Edict { id, amount: u128::MAX, output: 0 },
					],
					..default()
				}
				.encipher(),
	...
	fn edicts_which_refer_to_input_rune_with_no_balance_are_skipped() {
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id1, u128::MAX)]),
				(OutPoint { txid: txid2, vout: 0 }, vec![(id0, u128::MAX)]),
			],
		);
	}
	...
	fn edicts_over_max_inputs_are_ignored() {
		...
		let (txid0, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: u128::MAX / 2, output: 0 }],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid0, vout: 0 }, vec![(id, u128::MAX / 2)])],
		);
		...
		context.assert_runes(
			...
			[(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX / 2)])],
		);
	}
	...
	fn edicts_may_transfer_runes_to_op_return_outputs() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: u128::MAX, output: 1 }],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
					..default()
	...
	fn edicts_which_transfer_no_runes_to_output_create_no_balance_entry() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: u128::MAX, output: 0 },
					Edict { id: RuneId::default(), amount: 0, output: 1 },
				],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
	...
	fn split_in_etching() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: 0, output: 5 }],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
					..default()
	...
	fn split_in_etching_with_preceding_edict() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: 1000, output: 0 },
					Edict { id: RuneId::default(), amount: 0, output: 5 },
				],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid, vout: 0 }, vec![(id, 1000 + (u128::MAX - 1000) / 4 + 1)]),
				(OutPoint { txid, vout: 1 }, vec![(id, (u128::MAX - 1000) / 4 + 1)]),
				(OutPoint { txid, vout: 2 }, vec![(id, (u128::MAX - 1000) / 4 + 1)]),
				(OutPoint { txid, vout: 3 }, vec![(id, (u128::MAX - 1000) / 4)]),
			],
		);
	}
	...
	fn split_with_amount_in_etching() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: 1000, output: 5 }],
				etching: Some(Etching { rune: Some(Rune(RUNE)), premine: Some(4000), ..default() }),
				..default()
			},
			4,
		);
	...
	fn split_in_etching_with_amount_with_preceding_edict() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![
					Edict { id: RuneId::default(), amount: u128::MAX - 3000, output: 0 },
					Edict { id: RuneId::default(), amount: 1000, output: 5 },
				],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
	...
	fn split_in_etching_with_amount_with_following_edict() {
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid, vout: 0 }, vec![(id, u128::MAX - 4000 + 1000)]),
				(OutPoint { txid, vout: 1 }, vec![(id, 1000)]),
				(OutPoint { txid, vout: 2 }, vec![(id, 1000)]),
				(OutPoint { txid, vout: 3 }, vec![(id, 1000)]),
			],
	...
	fn split() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			outputs: 2,
			op_return: Some(
				Runestone { edicts: vec![Edict { id, amount: 0, output: 3 }], ..default() }
					.encipher(),
			),
			..default()
		});
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX / 2 + 1)]),
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, u128::MAX / 2)]),
			],
		);
	}
	...
	fn split_with_preceding_edict() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![
						Edict { id, amount: 1000, output: 0 },
						Edict { id, amount: 0, output: 3 },
					],
					..default()
				}
				.encipher(),
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id, 1000 + (u128::MAX - 1000) / 2 + 1)]),
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, (u128::MAX - 1000) / 2)]),
			],
		);
	}
	...
	fn split_with_amount() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			outputs: 2,
			op_return: Some(
				Runestone { edicts: vec![Edict { id, amount: 1000, output: 3 }], ..default() }
					.encipher(),
			),
			..default()
		});
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX - 1000)]),
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, 1000)]),
			],
		);
	}
	...
	fn split_with_amount_with_preceding_edict() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![
						Edict { id, amount: u128::MAX - 2000, output: 0 },
						Edict { id, amount: 1000, output: 5 },
					],
					..default()
				}
				.encipher(),
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX - 2000 + 1000)]),
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, 1000)]),
			],
		);
	}
	...
	fn split_with_amount_with_following_edict() {
		...
		context.assert_runes(
			...
			[
				(OutPoint { txid: txid1, vout: 0 }, vec![(id, u128::MAX - 4000 + 1000)]),
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, 1000)]),
				(OutPoint { txid: txid1, vout: 2 }, vec![(id, 1000)]),
				(OutPoint { txid: txid1, vout: 3 }, vec![(id, 1000)]),
			],
		);
	}
	...
	fn allocate_all_remaining_runes_in_etching() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: 0, output: 0 }],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(u128::MAX),
					..default()
	...
	fn allocate_all_remaining_runes_in_inputs() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			outputs: 2,
			op_return: Some(
				Runestone { edicts: vec![Edict { id, amount: 0, output: 1 }], ..default() }
					.encipher(),
			),
			..default()
		});
	...
	fn etching_with_amount_can_be_minted() {
		...
		let (txid0, id) = context.etch(
			Runestone {
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					terms: Some(Terms { cap: Some(100), amount: Some(1000), ..default() }),
					..default()
				}),
				..default()
			},
	...
	fn open_mints_can_be_limited_with_offset_end() {
		...
		context
			.assert_runes([(id, entry)], [(OutPoint { txid: txid1, vout: 0 }, vec![(id, 1000)])]);
	...
	fn open_mints_must_be_started_with_height_start() {
		...
		context
			.assert_runes([(id, entry0)], [(OutPoint { txid: txid1, vout: 0 }, vec![(id, 1000)])]);
	}
	...
	fn open_mints_with_offset_end_zero_can_be_premined() {
		...
		let (txid, id) = context.etch(
			Runestone {
				edicts: vec![Edict { id: RuneId::default(), amount: 1111, output: 0 }],
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(1111),
					terms: Some(Terms { amount: Some(1000), offset: (None, Some(0)), ..default() }),
					..default()
				}),
				..default()
			},
	...
	fn open_mints_can_be_limited_to_cap() {
		...
		let (txid0, id) = context.etch(
			Runestone {
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					terms: Some(Terms { amount: Some(1000), cap: Some(2), ..default() }),
					..default()
				}),
				..default()
			},
		...
		context.assert_runes(
			[(
				...
				RuneEntry {
					...
					mints: 1,
					etching: txid0,
					terms: Some(Terms { cap: Some(2), amount: Some(1000), ..default() }),
					..default()
				},
			)],
			[(OutPoint { txid: txid1, vout: 0 }, vec![(id, 1000)])],
	...
	fn open_mints_without_a_cap_are_unmintable() {
		...
		let (txid0, id) = context.etch(
			Runestone {
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					terms: Some(Terms { amount: Some(1000), offset: (None, Some(2)), ..default() }),
					..default()
				}),
				..default()
			},
	...
	fn open_mint_claims_can_use_split() {
		...
		context.assert_runes(
			...
			[
				...
				(OutPoint { txid: txid1, vout: 1 }, vec![(id, 500)]),
			],
		);
	}
	...
	fn runes_can_be_etched_and_premined_in_the_same_transaction() {
		...
		let (txid, id) = context.etch(
			Runestone {
				...
				edicts: vec![Edict { id: RuneId::default(), amount: 2000, output: 0 }],
				..default()
			},
			1,
		);
	...
	fn omitted_edicts_defaults_to_mint_amount() {
		...
		let (txid, id) = context.etch(
			Runestone {
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					terms: Some(Terms { offset: (None, Some(1)), ..default() }),
					..default()
				}),
				..default()
			},
		...
		context.assert_runes(
			[(
				...
				RuneEntry {
					...
					etching: txid,
					spaced_rune: SpacedRune { rune: Rune(RUNE), spacers: 0 },
					terms: Some(Terms { amount: None, offset: (None, Some(1)), ..default() }),
					timestamp: id.block,
					..default()
				},
			)],
		...
		let (txid, id) = context.etch(
			Runestone {
				etching: Some(Etching {
					rune: Some(Rune(RUNE)),
					premine: Some(2000),
					terms: Some(Terms { amount: Some(1000), cap: Some(1), ..default() }),
					..default()
				}),
				edicts: vec![Edict { id: RuneId::default(), amount: 2000, output: 0 }],
				..default()
	...
	fn transactions_cannot_claim_more_than_mint_amount() {
		...
		let txid1 = context.core.broadcast_tx(TransactionTemplate {
			...
			op_return: Some(
				Runestone {
					edicts: vec![Edict { id, amount: 2000, output: 0 }],
					mint: Some(id),
					..default()
				}
				.encipher(),
	...
	#[test]
	fn genesis_rune() {
		assert_eq!(Chain::Mainnet.first_rune_height(), SUBSIDY_HALVING_INTERVAL * 4,);
			...
			.assert_runes(
				[(
					...
					RuneEntry {
						...
						number: 0,
						premine: 0,
						spaced_rune: SpacedRune { rune: Rune(2055900680524219742), spacers: 128 },
						symbol: Some('\u{29C9}'),
						terms: Some(Terms {
							amount: Some(1),
							cap: Some(u128::MAX),
